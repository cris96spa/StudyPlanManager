...
/**
 * Form per la visualizzazione del piano di studio valido dello studente
 * @author De Lorenzo, Massaro, Spagnuolo
 *
 */
public class FormVisualizzaPianoDiStudio extends JDialog {
	private JTable table;
	private DefaultTableModel tableModelInsegnamenti;
	private List<Insegnamento> insegnamenti;
	private JLabel cfu;

	public FormVisualizzaPianoDiStudio(Studente studente, List<Insegnamento> teachings) {
		
		setTitle("Visualizzazione piano di studio");
		this.setModal(true);
	...
	/**
	 * Metodo invocato per un refresh della GUI
	 */
