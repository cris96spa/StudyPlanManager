...
/**
 * Form che consente di visualizzare e approvare/respingere il piano presentato dallo studente
 * @author De Lorenzo, Massaro, Spagnuolo
 *
 */
public class FormPianoDaValidare extends JDialog {
	...
	private JButton btnRespingi, btnApprova;

	public FormPianoDaValidare(Studente studente, List<Insegnamento> teachings) {
		
		setTitle("Assegnazione esito piano di studio");
		...
		btnRespingi = new JButton("Respingi");
		getContentPane().add(btnRespingi);
		...
		btnApprova = new JButton("Approva");
		...
		springLayout.putConstraint(SpringLayout.NORTH, btnApprova, 14, SpringLayout.SOUTH, panel_2);
		springLayout.putConstraint(SpringLayout.NORTH, btnRespingi, 0, SpringLayout.NORTH, btnApprova);
		springLayout.putConstraint(SpringLayout.EAST, btnRespingi, -28, SpringLayout.WEST, btnApprova);
		springLayout.putConstraint(SpringLayout.EAST, btnApprova, 0, SpringLayout.EAST, panel_1);
	...
	/**
	 * Metodo usato per il refresh della gui
	 */
	...
	/**
	 * Metodo invocato per l'approvazione del piano di studio
	 */
	private void approve() {
		dispose();
		controller.validateStudyPlan(studente);
	}
	
	/**
	 * Metodo invocato per respingere il piano di studio
	 */
	public void refuse() {
		dispose();
		controller.refuseStudyPlan(studente);
	}
